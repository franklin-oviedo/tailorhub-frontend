...
import { CreateOrder, Order, OrderStatus, PaginatedResponse } from '../../../core/models/domain.models';
...
export class OrdersService {
  ...
  create(payload: Omit<CreateOrder, 'id' | 'createdAt'>): Observable<CreateOrder> {
    return this.http.post<CreateOrder>(`${this.config.baseUrl}/orders`, payload);
  }
